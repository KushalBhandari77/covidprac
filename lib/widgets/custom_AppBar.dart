...
class _CustomAppBarState extends State<CustomAppBar> {
  ...
  analysis() {
    if (readResult(0.toString()) == true &&
        readResult(1.toString()) == true &&
        readResult(2.toString()) == true) {
      result = "You immediately need\n to consult the doctor";
      color = Colors.red;
    } else if (readResult(0.toString()) == false &&
        readResult(1.toString()) == false &&
        readResult(2.toString()) == false) {
